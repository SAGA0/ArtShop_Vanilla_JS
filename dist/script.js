...
/* harmony import */ var _modules_changeSize__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/changeSize */ "./src/js/modules/changeSize.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_changeSize__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
...
var burger = function burger(triggerBurger, menuBurger) {
  var burger = document.querySelector(triggerBurger),
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = 'Пожалуйста выбирите размер или материал картины';
...
var changeSize = function changeSize(imgBlock) {
  var blocks = document.querySelectorAll(imgBlock);
...
/* harmony default export */ __webpack_exports__["default"] = (changeSize);
...
var filter = function filter() {
  ...
  menu.addEventListener('click', function (e) {
    var classTarget = e.target.classList[0];
    var allElems = wrapper.querySelectorAll(".".concat(classTarget));
    typeFilter(allElems);
  });
  menu.addEventListener('click', function (e) {
    var target = e.target;
...
var forms = function forms() {
  ...
  var windows = document.querySelectorAll('[data-modal]'); // checkNumInputs('input[name="user_phone"]')
  ...
  function bindModal(modalTrigger, modalBlock, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        btnPressed = true; // let message = document.createElement('div')
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  var btn = document.querySelector(trigger); // let fail = document.createElement('img')
  ...
  btn.addEventListener('click', function () {
    Object(_services_request__WEBPACK_IMPORTED_MODULE_3__["getResourses"])('http://localhost:3000/styles').then(function (res) {
  ...
  function showError() {
    ...
    errorMessage.innerHTML = "\n        <img src=".concat(failure.fail, " alt>\n            <h4>").concat(failure.text, "</h4>\n        <a href=\"#\">\u041E\u0448\u0438\u0431\u043A\u0430</a>");
...
var getResourses = function getResourses(url) {
  var res;
  return regeneratorRuntime.async(function getResourses$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Couldnt get ".concat(url, ", status ").concat(res.status));
